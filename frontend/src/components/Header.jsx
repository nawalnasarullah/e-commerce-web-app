...
const Header = () => {
  ...
  return (
    <>
      {showMenu && (
        <div
          className="humberger__menu__overlay active"
          ...
          <div className="container">
            <div className="row">
              ...
              <div className="col-lg-4 col-md-6">
                <div className="header__top__right__auth d-flex pt-3 justify-content-end">
                
                  {
                    ...
                    <div>Hello! {user?.user?.firstName} {user?.user?.lastName}</div>
                    <span className="arrow_carrot-down"></span>
                    <ul>
                      <li>
